...
INSERT INTO PRODUCT (PID, PRODUCT_NAME, PRICE, STOCK_QTY)
VALUES -- Electronics
...
VALUES (1, 12, 2),
    ...
    (10, 21, 1),
    (9, 22, 1);
INSERT INTO REVIEW (RID, RATING, COMMENT, DATEE)
VALUES (
        1,
        5,
        'Great product! Excellent quality and performance.',
        '2023-05-10'
    ),
    (
        2,
        4,
        'Good value for money. Could be better with more features.',
        '2023-07-22'
    ),
    (
        3,
        3,
        'Average product. Not too impressed.',
        '2023-09-15'
    ),
    (
        4,
        2,
        'Disappointing purchase. Product did not meet expectations.',
        '2023-10-30'
    ),
    (
        5,
    ...
    (
        6,
        5,
        'Absolutely love it! Would highly recommend to others.',
        '2024-02-18'
    ),
    (
        7,
    ...
    (
        8,
        3,
        'Could be better. Not the best quality.',
        '2024-04-02'
    ),
    (
        9,
    ...
    (
        10,
        1,
        'Worst product ever. Broke within days of use.',
        '2024-06-28'
    );
INSERT INTO REVIEWS (UID, RID)
VALUES (1, 1),
    (1, 2),
    (2, 3),
    (2, 4),
    ...
    (6, 9),
    (7, 10);
INSERT INTO OF_PRODUCT (RID, PID)
VALUES (1, 1),
    (2, 1),
    (3, 2),
    (4, 3),
...
VALUES (1, 1),
    ...
    (31, 12),
(32, 12);
INSERT INTO ORDERR (OID, STATUS, TOTAL_AMOUNT, DATEE)
VALUES (1, 'Pending', 133598, '2024-03-25'),
...
INSERT INTO SHIPPING_DETAILS (OID, SDID, DATEE, TRACKING_NO, CARRIER)
VALUES (3, 1, '2024-03-25', 123456, 'Delhivery'),
...
INSERT INTO ORDER_DETAILS (OID, PID, QTY, PRICE_PER_UNIT)
VALUES (1, 2, 1, 99899.00),
    (1, 3, 1, 33699.00),
    (2, 5, 1, 199.00),
    (2, 6, 1, 3999.00),
    (2, 9, 1, 129.00),
    ...
    (14, 14, 1, 299.00),
    (15, 13, 1, 1499.00);
INSERT INTO PAYMENT (PAY_ID, STATUS, MODE, DATEE)
VALUES (1, 'Pending', 'Credit Card', '2024-03-25'),
